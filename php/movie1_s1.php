...
<html lang="en">
	...
	$res1=pg_query($db,"select * from m1s1;");
				$r1=pg_fetch_all($res1);
				//var_dump($r1);
				if($r1){
				if(count($r1)>0){
				foreach($r1 as $i){
				...
				echo "<input type=\"hidden\" name=\"filled1\" id=\"filled1\" value=$a1 />";
	...
	?><nav>
		...
		<img src="../img/movie1.jpg" alt="vikram_movie" id="vikram" />
			...
			<li><a href="movie1_s2.php"> 15:30 </a></li>
			<li><a href="movie1_s3.php"> 19:00 </a></li>
			</ul>
			
			<input type="hidden"  name="movie" value="m1s1" />
